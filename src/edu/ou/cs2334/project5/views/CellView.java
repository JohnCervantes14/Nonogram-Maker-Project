...
/**
 * This represents the view of one cell
 * @author the TA
 *
 */
public class CellView extends StackPane {
	...
	/**
	 * constructor a cell view given the size
	 * @param sideLength; cell size
	 */
	...
	/**
	 * set the cell state to new state
	...
	/**
	 * set the size to new side length
	 * @param sideLength; new size
	 */
